...
class BookListAPIView(generics.ListAPIView):
    ...
    def get_queryset(self):
        ...
        if user.is_staff or user.is_superuser:
            return Book.objects.filter(already_process=True).order_by('-created_at')
        print('User : ', user)
        ...
        if students :
            ...
            return Book.objects.filter(allowed_classes=user.student_profile.school_class, already_process=True).order_by('title')
